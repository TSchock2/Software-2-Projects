...
public class Program2 extends ProgramSecondary {
    ...
    public final void setName(String n) {
        ...
        // Assign this.name the value of n
        this.name = n;
    ...
    public final Map<String, Statement> newContext() {
        ...
        // Create empty context with new Map
        Map<String, Statement> newC = new Map1L<String, Statement>();
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        // Get temp variable to swap the context's of c and this
        Map<String, Statement> temp = this.context.newInstance();
        // Swap context of c to temp
        temp.transferFrom(c);
        // Swap context of this to context of c
        c.transferFrom(this.context);
        // Swap context of temp(context of c) to context of this
    ...
    public final Statement newBody() {
        ...
        // Create empty body with new Statement
        Statement newB = new Statement1();
    ...
    public final void swapBody(Statement b) {
        ...
        // Get temp variable to swap the body's of b and this
        Statement temp = this.body.newInstance();
        // Swap body of b to temp
        temp.transferFrom(b);
        // Swap body of this to body of b
        b.transferFrom(this.body);
        // Swap body of temp(body of b) to body of this
