...
public abstract class ListTest {
    ...
    public final void testRetreatLeftEmptyRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "blue", "red", "green");
        List<String> list2 = this.createFromArgsRef(0, "blue", "red", "green");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    public final void testRetreatLeftNonEmptyRightOne() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "purple", "blue", "green");
        List<String> list2 = this.createFromArgsRef(2, "purple", "blue", "green");
        /*
         * Call method under test
         */
        list1.retreat();
